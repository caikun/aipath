...
- [深度学习](dl/README.md)
  ...
  - [其他](dl/others/README.md)
    - [卡尔曼滤波](dl/others/KalmanFilter.md)
    - [深度学习四大名著](dl/others/深度学习四大名著.md)
  ...
  - [华为昇腾](frames/ascend/README.md)
    ...
    - [昇腾开发](frames/ascend/dev/README.md)
      - [模型迁移适配](frames/ascend/dev/model_convertion/README.md)
        ...
        - [PyTorch模型迁移](frames/ascend/dev/model_convertion/AOE.md)
        - [TBE算子开发](frames/ascend/dev/model_convertion/dev_DSL_op.md)
        - [使用AIPP和DVPP](frames/ascend/dev/model_convertion/use_AIPP_DVPP.md)
      - [开发常用命令](frames/ascend/dev/frequent_cmd.md)
    - [A200DK-A2开发套件](frames/ascend/dev/a200dk-a2/hello_a200dk-a2.md) 
...
- [OCR](ocr/README.md)
  ...
  - [PaddleOcr](ocr/paddleocr/README.md)
    ...
    - [PP-OCR](ocr/paddleocr/ppocr_introduction.md)
      ...
      - 模型压缩
          - [模型量化](ocr/paddleocr/deploy/slim/quantization/README.md)
          - [模型裁剪](ocr/paddleocr/deploy/slim/prune/README.md)
          - [知识蒸馏](ocr/paddleocr/knowledge_distillation.md)
      - [推理部署](ocr/paddleocr/deploy/README_ch.md)
        - [基于Python预测引擎推理](ocr/paddleocr/inference_ppocr.md)
        - [基于C++预测引擎推理](ocr/paddleocr/deploy/cpp_infer/readme_ch.md)
        - [服务化部署](ocr/paddleocr/deploy/pdserving/README_CN.md)
        - [端侧部署](ocr/paddleocr/deploy/lite/readme.md)
        - [Paddle2ONNX模型转化与预测](ocr/paddleocr/deploy/paddle2onnx/readme.md)
        - [云上飞桨部署工具](ocr/paddleocr/deploy/paddlecloud/README.md)
        - [Benchmark](ocr/paddleocr/benchmark.md)
    - [前沿算法与模型](ocr/paddleocr/algorithm_overview.md)
      - [文本检测算法](ocr/paddleocr/algorithm_det_db.md)
      - [文本识别算法](ocr/paddleocr/algorithm_rec_crnn.md)
      - [端到端OCR算法](ocr/paddleocr/algorithm_e2e_pgnet.md)
      - [表格识别算法](ocr/paddleocr/algorithm_table_master.md)
      - [关键信息抽取算法](ocr/paddleocr/algorithm_kie_layoutxlm.md)
      - [使用PaddleOCR架构添加新算法](ocr/paddleocr/add_new_algorithm.md)
    - [场景应用](ocr/paddleocr/applications)
    - 数据标注与合成
      - [半自动标注工具PPOCRLabel](./PPOCRLabel/README_ch.md)
      - [数据合成工具Style-Text](./StyleText/README_ch.md)
      - [其它数据标注工具](ocr/paddleocr/data_annotation.md)
      - [其它数据合成工具](ocr/paddleocr/data_synthesis.md)
    - 数据集
      - [通用中英文OCR数据集](ocr/paddleocr/dataset/datasets.md)
      - [手写中文OCR数据集](ocr/paddleocr/dataset/handwritten_datasets.md)
      - [垂类多语言OCR数据集](ocr/paddleocr/dataset/vertical_and_multilingual_datasets.md)
      - [版面分析数据集](ocr/paddleocr/dataset/layout_datasets.md)
      - [表格识别数据集](ocr/paddleocr/dataset/table_datasets.md)
      - [关键信息提取数据集](ocr/paddleocr/dataset/kie_datasets.md)

- [OpenCV4.0](cv/opencv/README.md)
